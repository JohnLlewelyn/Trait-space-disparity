...
saveRDS(hvs, "Data/data_for_plots/hvs.rds")
saveRDS(hvsprep, "Data/data_for_plots/hvsprep.rds")
...
half_cut <- function(x){
  ...
  gog <- x[x$Place2=="Gogo Reef"&!x$Place1%in%c("Braço Morto\nAcima and Abaixo","Nepean River","Ythan Estuary","Santa Cruz Estuary","Chile Reefs","Caribbean Reefs", "Miguasha Estuary","Gogo Reef"),]
  new <- rbind(nep,bra,yth,san,chi,car,mig,gog)
  new}
...
saveRDS(dist_time_plot, "Data/data_for_plots/dist_time_plot.rds")
saveRDS(vols, "Data/data_for_plots/vols.rds")
...
saveRDS(dist_habitat_plot, "Data/data_for_plots/dist_habitat_plot.rds")
...
saveRDS(dist_climate_plot, "Data/data_for_plots/dist_climate_plot.rds")
...
saveRDS(centroid_dist, "Data/data_for_plots/centroid_dist.rds")

pdf("Data/data_for_plots/centroid_distances_heatmap.pdf", width = 12, height = 11)
centroid_dist
dev.off()
...
saveRDS(overlap_stats_list,"Data/data_for_plots/overlap_stats_list.RDS")
...
saveRDS(jac_long, "Data/data_for_plots/jac_long.rds")
...
saveRDS(dist_time_plotJ, "Data/data_for_plots/dist_time_plotJ.rds")
...
saveRDS(dist_habitat_plotJ, "Data/data_for_plots/dist_habitat_plotJ.rds")
...
saveRDS(dist_climate_plotJ, "Data/data_for_plots/dist_climate_plotJ.rds")
...
saveRDS(jac_plot, "Data/data_for_plots/jack_plot.rds")

pdf("Data/data_for_plots/Jaccard_overlap_heatmap_flip.pdf", width = 12, height = 11)
jac_plot
dev.off()
...
jdf$Place2[jdf$Place2=="Gogo"] <- "Gogo Reef"
...
jdf$Place1[jdf$Place1=="Gogo"] <- "Gogo Reef"
...
saveRDS(jdf, "Data/jdf_meanBW.rds")
...
saveRDS(turn_plot, "Data/data_for_plots/turn_plot.rds")

pdf("Data/data_for_plots/Jaccard_turnover_heatmap_flip.pdf", width = 12, height = 11)
turn_plot
dev.off()
...
saveRDS(nest_plot, "Data/data_for_plots/nest_plot.rds")

pdf("Data/data_for_plots/Jaccard_nestedness_heatmap_flip.pdf", width = 12, height = 11)
nest_plot
dev.off()
...
saveRDS(time_turn_plot, "Data/data_for_plots/time_turn_plotJ.rds")
saveRDS(time_nest_plot, "Data/data_for_plots/time_nest_plotJ.rds")
...
saveRDS(habitat_turn_plot, "Data/data_for_plots/habitat_turn_plotJ.rds")
saveRDS(habitat_nest_plot, "Data/data_for_plots/habitat_nest_plotJ.rds")
...
climate_plot <- function (x, metric, Jlabel) {
 ...
 plotC
  ...
  saveRDS(climate_turn_plot, "Data/data_for_plots/climate_turn_plotJ.rds")
  saveRDS(climate_nest_plot, "Data/data_for_plots/climate_nest_plotJ.rds")
