...
mxs <- apply(bandw[, 2:9], MARGIN = 2, max)
mins <- apply(bandw[, 2:9], MARGIN = 2, min)

#recalculate hvs with specified bandwidths
bandwidths_fixed <- estimate_bandwidth(hvsprep[[1]], method="fixed", value=mins)
hvs <- hypervolume_gaussian(hvsprep[[1]], kde.bandwidth=bandwidths_fixed)

set.seed(123)
start_time <- Sys.time()
hvsprep <- lapply(site_data_frames1, function(x){x <-x[,1:8]})
bandwidths_fixed <- lapply(hvsprep, function(x) {x <-estimate_bandwidth(x,method="fixed", value=mins)})
hvs <- list()
...
saveRDS(dist_time_plot, "Data/data_for_plots/dist_time_plotMIN.rds")
saveRDS(vols, "Data/data_for_plots/volsMIN.rds")
...
saveRDS(dist_habitat_plot, "Data/data_for_plots/dist_habitat_plotMIN.rds")
...
saveRDS(dist_climate_plot, "Data/data_for_plots/dist_climate_plotMIN.rds")
...
saveRDS(centroid_dist, "Data/data_for_plots/centroid_distMIN.rds")
...
saveRDS(overlap_stats_list,"Data/data_for_plots/overlap_stats_listMIN.RDS")
...
saveRDS(jac_long, "Data/data_for_plots/jac_longMIN.rds")
...
saveRDS(dist_time_plotJ, "Data/data_for_plots/dist_time_plotJMIN.rds")
...
saveRDS(dist_habitat_plotJ, "Data/data_for_plots/dist_habitat_plotJMIN.rds")
...
saveRDS(dist_climate_plotJ, "Data/data_for_plots/dist_climate_plotJMIN.rds")
...
saveRDS(jac_plot, "Data/data_for_plots/jack_plotMIN.rds")
...
saveRDS(jdf, "GitHub_code&data_revised/Data/jdf_MINBW.rds")
#now make the plots
