...
Plot1 <- readRDS("Data/data_for_plots/Plot1_subsample10.RDS")
...
ggsave(plot = combined_plots, 
       filename = "~/Dropbox/Devonian fish/manuscript/ProcB revision/figures/figure 1. Three FD metrics all species and control for diversity10.png",
